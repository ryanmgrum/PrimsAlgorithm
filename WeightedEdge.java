...
public class WeightedEdge<V extends Comparable<? super V>> extends Edge {
    /** The weight value assigned to this WeightedEdge.
     */
    V weight;
    ...
    /** compareTo compares this WeightedEdge with the passed-in WeightedEdge;
     *  in particular, it compares their weight, and then their
     *  destination Vertex.
     * 
     * @param edge The WeightedEdge to compare to this WeightedEdge.
     * @return {@literal <} 0 if this WeightedEdge is less than the passed-in
     * WeightedEdge, 0 if equal, and {@literal >} 0 if this WeightedEdge is greater
     * than the passed-in WeightedEdge.
     * @throws IllegalArgumentException If the passed-in WeightedEdge is null.
     */
    public int compareTo(WeightedEdge<V> edge) throws IllegalArgumentException {
        if (edge == this)
            return 0;
        else if (edge == null)
